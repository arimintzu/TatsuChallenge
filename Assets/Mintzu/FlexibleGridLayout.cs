    ...
    public override void CalculateLayoutInputVertical()
    {
        ...
        switch (alignment)
        {
            ...
            case Alignment.Horizontal:
                ...
                cellWidth = (this.rectTransform.rect.width / columns) - ((spacing.x / columns) * (columns - 1)) - (padding.left / (float)columns) - (padding.right / (float)columns);

                cellHeight = (this.rectTransform.rect.height / rows) - ((spacing.y / rows) * (rows - 1)) - (padding.top / (float)rows) - (padding.bottom / (float)rows);
            ...
            default:
                ...
                cellHeight = (this.rectTransform.rect.width / columns) - ((spacing.x / columns) * (columns - 1)) - (padding.left / (float)columns) - (padding.right / (float)columns);

                cellWidth = (this.rectTransform.rect.height / rows) - ((spacing.y / rows) * (rows - 1)) - (padding.top / (float)rows) - (padding.bottom / (float)rows);
