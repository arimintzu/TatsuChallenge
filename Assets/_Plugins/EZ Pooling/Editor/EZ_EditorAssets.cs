    ...
    public static class EZ_EditorUtility
    {
        ...
        public static Texture LoadTexture(TextureData texData)
        {
            if (texData.tex == null)
            {
                ...
                {
                    if (!Directory.Exists("Assets/_StorePlugins/Editor Default Resources/" + EZ_EditorAssets.assetName))
                    {
                        Directory.CreateDirectory("Assets/_StorePlugins/Editor Default Resources/" + EZ_EditorAssets.assetName);
                    }

                    AssetDatabase.Refresh();

                    FileInfo fInfo = new FileInfo("Assets/_StorePlugins/" + EZ_EditorAssets.assetName + "/Editor/Texture Resources/" + texData.path);
                    fInfo.CopyTo("Assets/_StorePlugins/Editor Default Resources/" + EZ_EditorAssets.assetName + "/" + texData.path, true);

                    AssetDatabase.Refresh();

                    texData.tex = EditorGUIUtility.LoadRequired("Assets/_StorePlugins/Editor Default Resources/" + EZ_EditorAssets.assetName + "/" + texData.path) as Texture;
                }
            }
